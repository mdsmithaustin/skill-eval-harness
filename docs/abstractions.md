...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:10678`), Claude (`run_claude:10864`, capturing real
...
subagent runner (`run_subagent:13466`, which hosts record/replay tool I/O via `ToolReplayStore`),
