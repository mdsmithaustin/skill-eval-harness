...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:10671`), Claude (`run_claude:10857`, capturing real
...
subagent runner (`run_subagent:13459`, which hosts record/replay tool I/O via `ToolReplayStore`),
Jetty (`JettyClient:4088` and the export/run/import commands), and any runner that writes the
