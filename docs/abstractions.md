...
ships Pi answer smoke (`examples/adewale-workspace/run_pi_smoke.py`), Codex (`run_codex:10476`), Claude (`run_claude:10662`, capturing real
...
subagent runner (`run_subagent:13271`, which hosts record/replay tool I/O via `ToolReplayStore`),
...
(`prompt_assertion_leakage_findings:817`), and the split discipline are the part of the tool
